...
<head>
    ...
    <title>Website Undangan Pernikahan Aku dan Kamu</title>

    <!-- SEO Tag -->
    <meta name="author" content="ainul">
    <meta name="language" content="Indonesia">
    <meta name="robots" content="index, follow, max-image-preview:large">
    <meta name="googlebot" content="index, follow, max-image-preview:large">
    <meta name="title" content="Website Undangan Pernikahan Aku dan Kamu">
    <meta name="description" content="Website Undangan Pernikahan Aku dan Kamu">
    ...
    <meta property="og:title" content="Website Undangan Pernikahan Aku dan Kamu">
    <meta property="og:description" content="Website Undangan Pernikahan Aku dan Kamu">
    ...
    <meta property="og:image:alt" content="Website Undangan Pernikahan Aku dan Kamu">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:url" content="https://ulems.my.id">
    <meta property="og:site_name" content="Website Undangan Pernikahan Aku dan Kamu">

    <!-- Appearance -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="Website Undangan Pernikahan Aku dan Kamu">
    ...
    <main class="bg-dark text-light" data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <section class="container" id="home">
            ...
            <div class="text-center pt-4">
                ...
                <h1 class="font-esthetic my-4" style="font-size: 3rem;">Ulil & Devi</h1>
                <p class="mb-0" style="font-size: 1.5rem;">Jumat, 27 Juni 2024</p>

                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.app.google/tQctAaFYRvcsh1Zg6">
            ...
            <div class="text-center">
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic" style="font-size: 3rem;">Muhammad Ulil Albab</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Putra</p>
                        <p class="mb-0">Bapak Markuat & Ibu Ellya Contessa</p>
                        <p class="mb-0">Platar, Mangunjiwan, Demak</p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic" style="font-size: 3rem;">Devi Listiani</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Putri</p>
                        <p class="mb-0">Bapak Juwardi & Ibu Anisah</p>
                        <p class="mb-0">Moroasem, Banjarsari, Sayung, Demak</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-time="2024-06-27 00:00:00" id="count-down">
                            <div class="col-3 p-1">
                    ...
                    <div class="overflow-x-hidden">
                        <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <p>Waktu : 28 juni 2024 / 08.00 WIB - Selesai</p>
                        </div>

                        <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
                            <h1 class="font-esthetic" style="font-size: 2rem;">Acara</h1>
                            <p>Pukul : Bebas</p>
                        </div>
                    </div>
                    <!--ain maps-->
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.1802166969924!2d110.616804!3d-6.8689968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70e94b4ab3f463%3A0xd18e83c66d60d5c3!2sPlatar%2C%20Mangunjiwan%2C%20Kec.%20Demak%2C%20Kabupaten%20Demak%2C%20Jawa%20Tengah%2059515!5e0!3m2!1sid!2sid!4v1716658972071!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://maps.app.goo.gl/LKdyEcwQW7EvHXx69" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3">
                            <i class="fa-solid fa-map-location-dot me-2"></i>Lihat Google Maps
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-4" style="font-size: 0.9rem;">
                            Platar RT 05 Rw 06 Mangunjiwan, Kec. Demak, Kab. Demak.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div id="carousel-image-one" data-aos="fade-up" data-aos-duration="1500" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            ...
                            <div class="carousel-item">
                                <img src="./assets/images/3.jpg" alt="gambar 3" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
                    ...
                    <div id="carousel-image-two" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="./assets/images/4.jpg" alt="gambar 4" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/5.jpg" alt="gambar 5" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/6.jpg" alt="gambar 6" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-hidden">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down" data-aos-duration="1500">
                                ...
                                <p class="card-text mt-3 mb-0" style="font-size: 0.9rem;">No. Rekening 1637622262 </p>
                                <p class="card-text" style="font-size: 0.9rem;">a.n Muhammad Ulil Albab</p>

                                <!-- Ubah juga data-copy sesuai dengan no rekening -->
                                <button class="btn btn-light btn-sm rounded-3" data-copy="1637622262 " onclick="util.copy(this, 'Tersalin')" autofocus>Salin No. Rekening</button>
                            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <form method="post" id="form_komen">
                                ...
                                <div class="mb-3 animate-box">
                                    <label for="komentar" class="form-label">Ucapan dan Doa</label>
              ...
              function loadKomentar(){
                ...
                <div class="mb-3" hidden>
                    ...
                    <div id="alertDiv" class="alert alert-info alert-dismissible fade show" role="alert">
                        <h5>Bestieee!!!</h5>
                        <p class="m-0">Sekarang bisa format text seperti whatsapp lohh... cobainn sekaranggg,
                ...
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <small class="text-light">
                            Build with<i class="fa-solid fa-heart mx-1"></i>Ainul
                        </small>
                    </div>
                    <div class="col-auto">
                        <!-- <small>
    ...
    <div class="loading-page bg-black" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="text-center">
                ...
                <h1 class="font-esthetic my-4" style="font-size: 2.5rem;">Ulil & Devi</h1>
